...
- **Workbench catalog bridge (#117, planned):** [`WORKBENCH_CATALOG_READONLY_BRIDGE_PLAN.md`](../docs/WORKBENCH_CATALOG_READONLY_BRIDGE_PLAN.md) — read-only `catalog.db` display; no schema change; loader + UI slices follow
