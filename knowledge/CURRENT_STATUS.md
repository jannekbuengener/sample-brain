...
- **Workbench catalog bridge (#117, planned):** [`WORKBENCH_CATALOG_READONLY_BRIDGE_PLAN.md`](../docs/WORKBENCH_CATALOG_READONLY_BRIDGE_PLAN.md) — read-only loader shipped (`workbench_catalog.py`); UI slice follows
