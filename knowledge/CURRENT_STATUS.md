...
- **Workbench cue/loop/attack metadata** — loop + attack edit modes; attack suggestion API (`suggest_attack_ms`, #147); attack suggestion UI in progress; loop playback remains follow-up (#117 remains open)
