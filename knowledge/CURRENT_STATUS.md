...
- **Branch:** `main` @ `580f96a` (catalog read-only badge polish #161)
...
- **Workbench search UI (#117, planned):** [`WORKBENCH_SEARCH_UI_PLAN.md`](../docs/WORKBENCH_SEARCH_UI_PLAN.md) — structured local filters (source, type, key, status, BPM); text search shipped; **structured filters v1 (source, type, key, status) shipped**; BPM range and status polish planned; semantic/CLAP/#73 and sqlite-vec/#74 out of scope
