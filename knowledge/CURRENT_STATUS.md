...
- **Workbench search UI (#117, in progress):** [`WORKBENCH_SEARCH_UI_PLAN.md`](../docs/WORKBENCH_SEARCH_UI_PLAN.md) — structured local filters shipped (source, type, key, status, BPM range); unified search status bar shipped; active-filter summary + reset button planned; semantic/CLAP/#73 and sqlite-vec/#74 out of scope
