...
- **Workbench search UI (#117, planned):** [`WORKBENCH_SEARCH_UI_PLAN.md`](../docs/WORKBENCH_SEARCH_UI_PLAN.md) — structured local filters shipped (source, type, key, status, BPM range); status polish planned; semantic/CLAP/#73 and sqlite-vec/#74 out of scope
