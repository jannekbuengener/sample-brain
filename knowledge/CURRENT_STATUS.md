...
- **Workbench cue/loop metadata** — waveform play controls + preview from saved cue + Shift+click permanent cue set + read-only loop region; loop edit, loop playback, attack editor remain follow-ups (#117 remains open)
