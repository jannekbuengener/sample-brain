...
- **Partial:** Workbench MVP: waveform play surface (#117) — left-click plays from saved cue; right-click temp play at click; Shift+left-click sets cue permanently; loop region visible + editable via loop-edit mode (toggle, two-click set, clear); attack edit not yet.
