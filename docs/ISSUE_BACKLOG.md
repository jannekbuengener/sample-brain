...
- **Partial:** Workbench MVP covers result inspection, audio preview (#129–#130), read-only waveform (#131), cue metadata v1 (#133), click-to-set cue on waveform (no drag/loop/attack edit).
